...
public class Pong extends JFrame implements KeyListener {
    ...
    private void chequearColision(){
        if ( (pelota.x <= 75 && pelota.x >= 60) && pelota.y > paleta.y && pelota.y < paleta.y + paleta.altura)
        {
            if (pelota.veloX < 0)
                Buenas++;
        ...
        if ( (pelota.x >= 695 && pelota.x <= 710) && pelota.y > paleta.y && pelota.y < paleta.y + paleta.altura)
        {
            if (pelota.veloX > 0)
                Buenas++;
    ...
    g.fillRect(75, paleta.y, 15, paleta.altura);
    g.fillRect(710, paleta.y, 15, paleta.altura);
    }
